...
const dummyGachaList: GachaItem[] = [
  {
    id: '1',
    title: '星月ひなの限定ガチャ',
    description: '人気VTuber星月ひなの限定ボイス・イラストが当たる特別ガチャ！',
    vtuberName: '星月ひな',
    vtuberAvatar: '/avatars/placeholder.svg',
    singlePrice: 100,
    tenDrawPrice: 1000,
    availableUntil: new Date('2025-12-31'),
    isActive: true,
    thumbnailUrl: '/gacha/hoshitsuki-hina-gacha.jpg',
    totalDraws: 15420,
    rareItemCount: 12,
    popularityRank: 1,
    isLimitedTime: true
  },
  {
    id: '2', 
    title: '桜井みおスペシャルガチャ',
    description: '桜井みおちゃんの秘蔵ボイス＆直筆メッセージが当たるかも！',
    vtuberName: '桜井みお',
    vtuberAvatar: '/avatars/placeholder.svg',
    singlePrice: 100,
    tenDrawPrice: 1000,
    ...
    isActive: true,
    thumbnailUrl: '/gacha/sakurai-mio-gacha.jpg',
    totalDraws: 9832,
    rareItemCount: 8,
    popularityRank: 2,
    isLimitedTime: false
  },
  {
    id: '3',
    title: '音羽ゆめの夏祭りガチャ',
    description: '夏祭り限定！音羽ゆめの浴衣姿イラスト＆夏の思い出ボイス',
    vtuberName: '音羽ゆめ',
    vtuberAvatar: '/avatars/placeholder.svg',
    singlePrice: 100,
    tenDrawPrice: 1000,
    ...
    isActive: true,
    thumbnailUrl: '/gacha/otowa-yume-gacha.jpg',
    totalDraws: 7654,
    rareItemCount: 15,
    popularityRank: 3,
    isLimitedTime: true
  },
  {
    id: '4',
    title: '白雪りんの冬物語ガチャ',
    description: '冬季限定！白雪りんの雪景色イラスト＆クリスマスボイス',
    vtuberName: '白雪りん',
    vtuberAvatar: '/avatars/placeholder.svg',
    singlePrice: 100,
    tenDrawPrice: 1000,
    ...
    isActive: true,
    thumbnailUrl: '/gacha/shirayuki-rin-gacha.jpg',
    totalDraws: 12890,
    rareItemCount: 10,
    popularityRank: 4,
    isLimitedTime: false
  },
  {
    id: '5',
    title: '紅葉あやねの秋コレクション',
    description: '秋の紅葉をテーマにした紅葉あやねの限定アイテムコレクション',
    vtuberName: '紅葉あやね',
    vtuberAvatar: '/avatars/placeholder.svg',
    singlePrice: 100,
    tenDrawPrice: 1000,
    ...
    isActive: true,
    thumbnailUrl: '/gacha/momiji-ayane-gacha.jpg',
    totalDraws: 6234,
    rareItemCount: 7,
    popularityRank: 5,
    isLimitedTime: false
